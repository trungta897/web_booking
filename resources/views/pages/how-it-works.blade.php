    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h1 class="text-4xl font-bold text-gray-900">How It Works</h1>
                <p class="mt-4 text-lg text-gray-600">Get started with online tutoring in three simple steps</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                ...
                <div class="bg-white p-8 rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-300">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 text-center mb-4">Find Your Perfect Tutor</h3>
                    <p class="text-gray-600 text-center">
                        Browse through our extensive list of qualified tutors. Filter by subject, price, and rating to find the perfect match for your needs.
                    </p>
                </div>
                ...
                <div class="bg-white p-8 rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-300">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 text-center mb-4">Book a Session</h3>
                    <p class="text-gray-600 text-center">
                        Choose a time that works for you and book your tutoring session. Our platform makes scheduling easy and flexible.
                    </p>
                </div>
                ...
                <div class="bg-white p-8 rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-300">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 text-center mb-4">Start Learning</h3>
                    <p class="text-gray-600 text-center">
                        Meet with your tutor online and begin your learning journey. Our platform provides a seamless virtual classroom experience.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-8 mb-16">
                <h2 class="text-2xl font-bold text-gray-900 mb-8 text-center">Why Choose Our Platform?</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div class="text-center">
                        ...
                        <p class="text-gray-600">Book sessions at times that work for you</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 mb-2">Verified Tutors</h3>
                        <p class="text-gray-600">All tutors are verified and qualified</p>
                    </div>
