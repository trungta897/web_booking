            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        ...
                        <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <p class="mt-1">{{ $tutorProfile->user->name }}</p>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Email</p>
                                <p class="mt-1">{{ $tutorProfile->user->email }}</p>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Hourly Rate</p>
                                <p class="mt-1">${{ number_format($tutorProfile->hourly_rate, 2) }}</p>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Experience (years)</p>
                                <p class="mt-1">{{ $tutorProfile->experience_years }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-2 text-gray-600 dark:text-gray-300">{{ $tutorProfile->bio }}</p>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-2 space-y-4">
                            @foreach($tutorProfile->education as $education)
